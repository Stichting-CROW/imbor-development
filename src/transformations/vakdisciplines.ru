...
insert {
   GRAPH imbor: {
        ...
        imbor:Zoekingang 
            a rdfs:Container ;
            skos:prefLabel "Zoekingang"@nl ;
            skos:definition "Verzamelgroep van alle zoekingangen"@nl ;
            rdfs:member ?vakdisciplineUri ;
            .
   }
}
WHERE {
    graph <csv:table/imborKern_K_ZoekingangenObjecttypen> {
        []
            csv:Zoekingang ?Vakdiscipline ;
