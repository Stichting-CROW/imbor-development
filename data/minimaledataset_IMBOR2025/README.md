# Minimale Dataset IMBOR naar SHACL shapes
...
>2026-03-18
>De shapes die uit deze shapes komen zijn middels een CONSTRUCT query nog omgezet vanwege een andere publicatie vorm. De query daarvoor is:
...
- Een Excel-bestand met de Minimale Dataset. In origine verkregen van [Objectgericht.nl](https://objectgericht.nl. Dit bevat rijen met telkens een combinatie van een objecttype (bijvoorbeeld "Boom"), een attribuut (bijvoorbeeld "Hoogte") en een kolom die aangeeft of dat attribuut verplicht is: Ja of Nee.
